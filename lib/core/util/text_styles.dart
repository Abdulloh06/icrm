...
class AppTextStyles {
  ...
  static TextStyle apppTextWhite = const TextStyle(
    color: Colors.white,
    fontSize: 16,
    fontWeight: FontWeight.w500,
  );

  static TextStyle appTextForm = const TextStyle(
  ...
  static TextStyle headerTask2 = const TextStyle(
    fontSize: 25,
    fontFamily: 'Rubik',
    fontWeight: FontWeight.w500,
  );
  ...
  static TextStyle toggleText = const TextStyle(fontSize: 12);
  ...
  static TextStyle priorityHighText = const TextStyle(
    fontSize: 12,
    // fontWeight: FontWeight.w900,
    color: Color.fromARGB(255, 255, 97, 87),
  );

  static TextStyle priorityComplatedText = const TextStyle(
    fontSize: 10,
    color: Color.fromARGB(255, 97, 200, 119),
  );

  static TextStyle priorityInProgressText = const TextStyle(
    fontSize: 12,
  ...
  static TextStyle mainTextWhiteSmall = const TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w700,
    color: Color.fromARGB(255, 255, 255, 255),
  );

  static TextStyle textProcentIndicatorWhite = TextStyle(
    fontSize: 12,
    color: Colors.white,
    fontWeight: FontWeight.bold,
  );

  static TextStyle textProcentIndicatorBlack = TextStyle(
    fontSize: 12,
    color: Colors.black,
    fontWeight: FontWeight.bold,
  );
